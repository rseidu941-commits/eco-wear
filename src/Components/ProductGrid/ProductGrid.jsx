      ...
      <div className="product-grid__container">
            ...
            <nav className="product-grid__nav">
              <button
                ...
                className={`product-grid__nav-btn ${
                  selectedCategory === "All" ? "product-grid__nav-btn--active" : ""
                }`}
              ...
              <button
                type="button"
                className={`product-grid__nav-btn ${
                  selectedCategory === "Dresses" ? "product-grid__nav-btn--active" : ""
                }`}
              ...
              <button
                type="button"
                className={`product-grid__nav-btn ${
                  selectedCategory === "Jewelry" ? "product-grid__nav-btn--active" : ""
                }`}
        ...
        <div className="product-grid__list">
          {filteredProducts.length > 0 ? (
            ...
            <p className="product-grid__empty">No products matched your search.</p>
          )}
        </div>
